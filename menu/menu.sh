...
echo -e "\e[1m==============================================\033[0m"
echo -e "\e[1m OS           \e[0m:  "`hostnamectl | grep "Operating System" | cut -d ' ' -f5-`	
echo -e "\e[1m IP           \e[0m:  $IPVPS"
echo -e "\e[1m ASN          \e[0m:  $ISP"
echo -e "\e[1m CITY         \e[0m:  $CITY"
echo -e "\e[1m DOMAIN       \e[0m:  $domain"
echo -e "\e[1m DATE & TIME  \e[0m:  $DATE2"
echo -e "\e[1m==============================================\033[0m"
echo -e "\e[37m                  MENU              \e[0m"
echo -e "\e[1m==============================================\033[0m"
echo -e "\e[1m1. SSH MENU"
echo -e "\e[1m2. VMESS MENU"
echo -e "\e[1m3. VLESS MENU"
echo -e "\e[1m4. TROJAN MENU"
echo -e "\e[1m5. SHADOWSOCKS MENU"
echo -e "\e[1m6. SYSTEM MENU"
echo -e   ""
echo -e   " Press x or [ Ctrl+C ] • To Exit"
echo -e   ""
echo -e "\e[1m==============================================\033[0m"
echo -e " \e[1mCLIENT NAME \E[0m: $Name"
echo -e " \e[1mEXPIRED     \E[0m: $Exp2"
echo -e "\e[1m==============================================\033[0m"
echo -e   ""
